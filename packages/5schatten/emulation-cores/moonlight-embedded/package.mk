...
PKG_VERSION="d54d348" #v2.4.7
PKG_ARCH="any"
PKG_LICENSE="LGPL"
PKG_SITE="https://github.com/irtimmer/moonlight-embedded"
PKG_URL="https://github.com/irtimmer/moonlight-embedded.git"
PKG_DEPENDS_TARGET="toolchain alsa-lib avahi curl enet expat ffmpeg libcec libevdev pulseaudio openssl opus SDL2 SDL_GameControllerDB systemd"
